...
write.csv(
  per_gene_stats_dt,
  file = sprintf(
    "%s/data/annotation/gut_dtrs/gut_dtr_per_gene_stats.csv",
    find_rstudio_root_file()
  ),
  row.names = FALSE
)
...
write.csv(
  perfect_stats_dt,
  file = sprintf(
    "%s/data/annotation/gut_dtrs/gut_dtr_perfect_stats.csv",
    find_rstudio_root_file()
  ),
  row.names = FALSE
)
...
write.csv(
  pairwise_fisher_dt,
  file = sprintf(
    "%s/data/annotation/gut_dtrs/gut_dtr_pairwise_fisher.csv",
    find_rstudio_root_file()
  ),
  row.names = FALSE
)

cat("CSV files written to data/annotation/gut_dtrs/:\n")
cat("  - gut_dtr_per_gene_stats.csv\n")
cat("  - gut_dtr_perfect_stats.csv\n")
cat("  - gut_dtr_pairwise_fisher.csv\n")
```
