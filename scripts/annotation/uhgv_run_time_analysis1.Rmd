...
```{r}
pal <- wes_palette("GrandBudapest1", type = "discrete")[c(1,2,3)]
...
ggsave(
  time100p,
  file = sprintf("%s/charts/time_100uhgv_bar1.pdf",
          wd)
)

ggsave(
  time100p,
  file = sprintf("%s/charts/time_100uhgv_bar1.png",
          wd)
)
```
